	...
	<div class="row justify-content-center">
		...
		<div class="col-lg-8 col-md-10 col-sm-12">
			<form id="form-modify" method="POST" action="">
				<input type="hidden" id="aptCode" name="aptCode" value="${aptSale.aptCode}">
				<input type="hidden" id="no" name="no" value="${aptSale.no}">
				<div class="mb-3">
				...
				<div class="col-auto text-center">
					<button type="button" id="btn-register"
						class="btn btn-outline-primary mb-3">주택매매정보 수정완료</button>
	...
	document.querySelector("#btn-register").addEventListener("click",
			function() {
				if (!document.querySelector("#dealDate").value) {
					...
					form.setAttribute("action", "${root}/houseAdmin/aptsale/modify");
