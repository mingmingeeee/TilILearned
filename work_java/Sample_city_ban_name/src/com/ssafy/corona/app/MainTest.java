...
public class MainTest {
	public static void main(String[] args) {
		...
		VirusMgr vmgr = VirusMgrImpl.getVirusMgrImpl();
		VirusMgr vmgr2 = VirusMgrImpl.getVirusMgrImpl();
		
		if(vmgr==vmgr2) {
			System.out.println("싱글턴 완료!!!");
		}
		System.out.println();		
